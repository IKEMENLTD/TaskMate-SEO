...
なぜかというと、エラーは「失敗」じゃなくて<span class="text-teal"><span class="text-teal">**「フィードバック」**</span></span>だからです。
...
きっと、そのエラーは「敵」じゃなくて、<span class="text-teal"><span class="text-teal">**「次のステップへのヒント」**</span></span>だったと気づくはずです。
