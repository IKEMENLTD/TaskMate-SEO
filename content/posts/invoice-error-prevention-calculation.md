...
ある試算によると、1件の請求書ミスを訂正するのに平均2時間かかり、年間10件のミスがあれば**年間20時間、時給換算で約3万円のコスト**が発生します。
...
月に100件の請求書を作成する企業なら、**月に約20時間**を請求書作成に費やしている計算になります。
...
1回のミスで失われた信用を取り戻すには、何十回もの正確な取引が必要です。
