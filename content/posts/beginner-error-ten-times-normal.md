...
<img src="/icons/lightbulb.svg" alt="アイデア" class="inline-icon" width="20" height="20" /> **1. エラー処理を組み込んだ安全設計**
コード全体を `try-catch` で囲み、エラーが発生した場合は自動的にメールで通知が届きます。シートが見つからない場合も適切にエラーメッセージを表示します。

<img src="/icons/calendar.svg" alt="スケジュール" class="inline-icon" width="20" height="20" /> **2. 今週の範囲を自動計算**
月曜日から金曜日までの範囲を自動で計算し、その期間に完了したタスクだけを抽出します。日付の計算ミスを防ぎます。

<img src="/icons/send.svg" alt="送信" class="inline-icon" width="20" height="20" /> **3. 自動メール送信**
